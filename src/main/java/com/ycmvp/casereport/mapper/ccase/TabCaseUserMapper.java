...
public interface TabCaseUserMapper {
    ...
    @Insert("INSERT INTO TAB_CASE_USER(ID, CASE_DATE, USERID, OPT_TIME, STROKE_DEST, STROKE_VIA, STROKE_DATE_GO, STROKE_DATE_BACK, STROKE_DESCRIPTION, TOUCHING_SIGN, BODY_SIGN, BODYCASE, DOCTOR_SIGN, HOSPITAL, DOCTOR_TIME, DECTOR_INFO, CASE_EXPLAIN, USER_CITY, USER_COMMUNITY, USER_BUILDING, USER_CALL_COMMUNITY, USER_MEET, USER_PUB_PLACE, BODY_TEMPERATURE, ISOLATION_TAG, ISOLATION_DATE, UNISOLATION_DATE, ISOLATION_STATUS, ISOLATION_DESCRIPTION, WORK_STATUS, EPIDEMIC_COMMUNITY_COUNT, STRANDED_SIGN) " + 
            "VALUES(#{id}, #{caseDate}, #{userid}, #{optTime}, #{strokeDest}, #{strokeVia}, #{strokeDateGo}, #{strokeDateBack}, #{strokeDescription}, #{touchingSign}, #{bodySign}, #{bodycase}, #{doctorSign}, #{hospital}, #{doctorTime}, #{dectorInfo}, #{caseExplain}, #{userCity}, #{userCommunity}, #{userBuilding}, #{userCallCommunity}, #{userMeet}, #{userPubPlace}, #{bodyTemperature}, #{isolationTag}, #{isolationDate}, #{unisolationDate}, #{isolationStatus}, #{isolationDescription}, #{workStatus}, #{epidemicCommunityCount}, #{strandedSign})")
    int create(TabCaseUser tabCaseUser);

    @Update("UPDATE TAB_CASE_USER SET CASE_DATE=#{caseDate}, USERID=#{userid}, OPT_TIME=#{optTime}, STROKE_DEST=#{strokeDest}, STROKE_VIA=#{strokeVia}, STROKE_DATE_GO=#{strokeDateGo}, STROKE_DATE_BACK=#{strokeDateBack}, STROKE_DESCRIPTION=#{strokeDescription}, TOUCHING_SIGN=#{touchingSign}, BODY_SIGN=#{bodySign}, BODYCASE=#{bodycase}, DOCTOR_SIGN=#{doctorSign}, HOSPITAL=#{hospital}, DOCTOR_TIME=#{doctorTime}, DECTOR_INFO=#{dectorInfo}, CASE_EXPLAIN=#{caseExplain}, USER_CITY=#{userCity}, USER_COMMUNITY=#{userCommunity}, USER_BUILDING=#{userBuilding}, USER_CALL_COMMUNITY=#{userCallCommunity}, USER_MEET=#{userMeet}, USER_PUB_PLACE=#{userPubPlace}, BODY_TEMPERATURE=#{bodyTemperature}, ISOLATION_TAG=#{isolationTag}, ISOLATION_DATE=#{isolationDate}, UNISOLATION_DATE=#{unisolationDate}, ISOLATION_STATUS=#{isolationStatus}, ISOLATION_DESCRIPTION=#{isolationDescription}, WORK_STATUS=#{workStatus}, EPIDEMIC_COMMUNITY_COUNT=#{epidemicCommunityCount}, STRANDED_SIGN=#{strandedSign} " + 
            "WHERE ID=#{id}")
    ...
    @Select("SELECT ID, CASE_DATE, USERID, OPT_TIME, STROKE_DEST, STROKE_VIA, STROKE_DATE_GO, STROKE_DATE_BACK, STROKE_DESCRIPTION, TOUCHING_SIGN, BODY_SIGN, BODYCASE, DOCTOR_SIGN, HOSPITAL, DOCTOR_TIME, DECTOR_INFO, CASE_EXPLAIN, USER_CITY, USER_COMMUNITY, USER_BUILDING, USER_CALL_COMMUNITY, USER_MEET, USER_PUB_PLACE, BODY_TEMPERATURE, ISOLATION_TAG, ISOLATION_DATE, UNISOLATION_DATE, ISOLATION_STATUS, ISOLATION_DESCRIPTION, WORK_STATUS, EPIDEMIC_COMMUNITY_COUNT, STRANDED_SIGN " +
            "FROM TAB_CASE_USER " +
            "WHERE ID=#{id}")
